...
//
//		if (choice1.equals("1"))
//			result = TCManager.getInstance().calculateTax(income, inputType,
//					TaxAPIType.SALARIED, 2014);
//		else if (choice1.equals("2"))
//			result = TCManager.getInstance().calculateTax(income, inputType,
//					TaxAPIType.NON_SALARIED, 2014);
//
//		System.out.println("Taxable Income Yearly : "
//				+ result.getTaxableIncomeYearly());
//		System.out.println("Taxable Income Monthly : "
//				+ result.getTaxableIncomeMonthly());
//
//		System.out.println("Total Tax Payable Yearly : "
//				+ result.getTaxYearly());
//		System.out.println("Total Tax Payable Monthly : "
//				+ result.getTaxMonthly());
//
//		System.out.println("Take Home Income Yearly : "
//				+ result.getTakeHomeIncomeYearly());
//		System.out.println("Take Home Income Monthly : "
//				+ result.getTakeHomeIncomeMonthly());
//
...
//
//		if (choice1.equals("1"))
//			result = TCManager.getInstance().calculateImpactOfIncrement(income,
//					increase, inputType, TaxAPIType.SALARIED, 2014);
//		else if (choice1.equals("2"))
//			result = TCManager.getInstance().calculateImpactOfIncrement(income,
//					increase, inputType, TaxAPIType.NON_SALARIED, 2014);
//
//		System.out.println("Taxable Income Yearly : "
//				+ result.getTaxableIncomeYearly());
//		System.out.println("Taxable Income Monthly : "
//				+ result.getTaxableIncomeMonthly());
//
//		System.out.println("Expected Taxable Income Yearly : "
//				+ result.getExpectedTaxableIncomeYearly());
//		System.out.println("Expected Taxable Income Monthly : "
//				+ result.getExpectedTaxableIncomeMonthly());
//
//		System.out.println("Increase In Taxable Income Yearly : "
//				+ result.getIncreaseInTaxableIncomeYearly());
//		System.out.println("Increase In Taxable Income Monthly : "
//				+ result.getIncreaseInTaxableIncomeMonthly());
//
//		System.out.println("Total Tax Payable Yearly : "
//				+ result.getTaxYearly());
//		System.out.println("Total Tax Payable Monthly : "
//				+ result.getTaxMonthly());
//
//		System.out.println("Total Expected Tax Payable Yearly : "
//				+ result.getExpectedTaxYearly());
//		System.out.println("Total Expected Tax Payable Monthly : "
//				+ result.getExpectedTaxMonthly());
//
//		System.out.println("Increase In Tax Payable Yearly : "
//				+ result.getIncreaseInTaxYearly());
//		System.out.println("Increase In Tax Payable Monthly : "
//				+ result.getIncreaseInTaxMonthly());
//
//		System.out.println("Take Home Income Yearly : "
//				+ result.getTakeHomeIncomeYearly());
//		System.out.println("Take Home Income Monthly : "
//				+ result.getTakeHomeIncomeMonthly());
//
//		System.out.println("Expected Take Home Income Yearly : "
//				+ result.getExpectedTakeHomeIncomeYearly());
//		System.out.println("Expected Take Home Income Monthly : "
//				+ result.getExpectedTakeHomeIncomeMonthly());
//
//		System.out.println("Increase In Take Home Income Yearly : "
//				+ result.getIncreaseInTakeHomeIncomeYearly());
//		System.out.println("Increase In Take Home Income Monthly : "
//				+ result.getIncreaseInTakeHomeIncomeMonthly());
//
//		System.out.println("Average Rate of Tax : " + result.getAvgRateOfTax()
//				+ "%");
//
//		System.out.println("Expected Average Rate of Tax : "
//				+ result.getExpAvgRateOfTax() + "%");
//
//	}
//
...
//					zakat, donation, shares, insurancePremium, pensionFund,
//					age, houseLoanInterest, InputType.YEARLY,
//					TaxAPIType.SALARIED, 2014);
//		else if (choice1.equals("2"))
//			result = TCManager.getInstance().calculateTaxPlanning(income,
//					zakat, donation, shares, insurancePremium, pensionFund,
...
//		System.out.println("Donation Deduction : "
//				+ result.getDonationDeduction());
//		System.out.println("Shares and Insurance Deduction : "
//				+ result.getShares_InsuranceDeduction());
//		System.out.println("Pension Fund Deduction : "
//				+ result.getPensionDeduction());
//		System.out.println("House Loan Interest Deduction : "
//				+ result.getHouseLoanInterestDeduction());
//
//		System.out.println("Total Tax Saving : " + result.getTotalTaxSaving());
//		System.out.println("Limited To Actual Tax Payable : "
//				+ result.getActualTaxPayable());
...
//		System.out
//				.println("Enter Amount of Investment In Approved Pension Fund :  ");
